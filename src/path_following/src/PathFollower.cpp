...
bool Follower::getTransform()
{
    ...
    try
    {
        ...
        robot_global_pose = tf_buffer_->lookupTransform("map", "baselink", tf2::TimePointZero);
...
void Follower::visualize()
{
    ...
    current_point_marker.header.frame_id = "baselink";
    ...
    target_point_marker.header.frame_id = "baselink";
    ...
    velocity_arrow.header.frame_id = "baselink";
