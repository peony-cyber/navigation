...
def generate_launch_description():
    ...
    map_server = Node(
        ...
        output='screen',
        parameters=[{
            'yaml_filename': os.path.join(ws_root, 'src', 'path_searching', 'sim_maps', 'map.yaml'),
            'topic_name': 'map',
            'frame_id': 'map',
            'use_sim_time': False,
        }],
    ...
    #     name='static_tf_pub',
    #     output='screen',
    #     arguments=['0', '0', '0', '-1.570796326', '0', '0', 'body', 'baselink'],
    # )
    ...
    static_tf_pub2 = Node(
        ...
        name='static_tf_pub',
        output='screen',
        arguments=['0.5', '8.05', '0', '1.570796326', '0', '0', 'map', 'lidar'],
    )
